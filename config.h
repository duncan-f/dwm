...
static Key keys[] = {
	...
	{ Mod1Mask,			  XK_p,             spawn,          SHCMD("volman toggle") },
    ...
    { 0,                  XF86XK_MonBrightnessDown, spawn,  SHCMD("blman dec 5; pkill -RTMIN+3 dwmblocks") },
    { 0,                  XF86XK_MonBrightnessUp,   spawn,  SHCMD("blman inc 5; pkill -RTMIN+3 dwmblocks") },
    { MODKEY,             XF86XK_MonBrightnessDown, spawn,  SHCMD("blman set 15; pkill -RTMIN+3 dwmblocks") },
    { MODKEY,             XF86XK_MonBrightnessUp,   spawn,  SHCMD("blman set 100; pkill -RTMIN+3 dwmblocks") },
    { 0,                  XF86XK_AudioPrev,         spawn,  SHCMD("volman prev; pkill -RTMIN+6 dwmblocks") },
    { 0,                  XF86XK_AudioNext,			spawn,  SHCMD("volman next; pkill -RTMIN+6 dwmblocks") },
    { 0,                  XF86XK_AudioPlay,         spawn,  SHCMD("volman toggle; pkill -RTMIN+6 dwmblocks") },
    { 0,                  XF86XK_AudioRaiseVolume,  spawn,  SHCMD("volman inc; pkill -RTMIN+4 dwmblocks") },
    { 0,                  XF86XK_AudioLowerVolume,  spawn,  SHCMD("volman dec; pkill -RTMIN+4 dwmblocks") },
    { 0,                  XF86XK_AudioMute,         spawn,  SHCMD("volman mute; pkill -RTMIN+4 dwmblocks") },
    { MODKEY,             XF86XK_AudioRaiseVolume,  spawn,  SHCMD("volman next; pkill -RTMIN+6 dwmblocks") },
    { MODKEY,             XF86XK_AudioLowerVolume,  spawn,  SHCMD("volman prev; pkill -RTMIN+6 dwmblocks") },
    { MODKEY,             XF86XK_AudioMute,         spawn,  SHCMD("volman stop; pkill -RTMIN+6 dwmblocks") },
};
